...
\paragraph{Example:} Let's consider a monovariant allocation strategy to run the following example.
...
\textbf{TODO:} address FLOPS reviewer's concerns regarding Cook's transformation and Jones' use for analysis.
