...
%
Such an approach is unlikely to capture all ``real language's'' formalizations.
%
An additional abstraction also detracts from the operational intuitions and simplicity of the methodology.
...
\paragraph{Notation:} we make judicious use of the isomorphism between associations of $n$-tuples to spare the paper from excessive parentheses, even though our implementations are in a Lisp-descendent language.
