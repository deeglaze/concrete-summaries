...
%
PDCFA claims there is no loop, and depending on the implementation, that the result is true.
%
...
\begin{claim}(Correctness of Concrete Summarization)\label{thm:concrete-tabular}
...
\begin{claim}[Correctness of PDCFA]\label{thm:global}
