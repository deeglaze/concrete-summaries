...
\begin{mathpar}
  ...
  \inferrule{\mkont \in \unroll{\mktab}{\mkont', \bot}}{\mkframe:\mkont \in \unroll{\mktab}{\mkframe:\mkont', G}} \\
  \inferrule{G \neq \mctx \\
             \mkont^\circ \in \mktab(\mctx) \\
             \mkont \in \unroll{\mktab}{\mkont^\circ, \mctx}}
            {\mkont \in \unroll{\mktab}{\krt{\mctx}, G}}  
\end{mathpar}
Consider later uses of $\mathit{unroll}$ to implicitly give $\bot$ for $G$.
